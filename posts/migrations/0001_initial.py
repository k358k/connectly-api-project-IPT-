    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('post_type', models.CharField(choices=[('image', 'Image'), ('video', 'Video'), ('text', 'Text')], default='text', max_length=10)),
        ...
        migrations.AddIndex(
            model_name='user',
            index=models.Index(fields=['google_id'], name='posts_user_google__7c75e5_idx'),
        ),
        migrations.AddIndex(
            model_name='user',
        ...
        migrations.AddIndex(
            model_name='externalauthprovider',
            index=models.Index(fields=['provider', 'provider_user_id'], name='posts_exter_provide_bbecae_idx'),
        ),
        migrations.AddIndex(
            model_name='externalauthprovider',
            index=models.Index(fields=['user', 'provider'], name='posts_exter_user_id_72bfff_idx'),
        ),
